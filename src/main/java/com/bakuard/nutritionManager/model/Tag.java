...
/**
 * Теги используются для уточнения пользователем данных о продуктах, блюдах и меню, а также для последующей
...
public class Tag implements Comparable<Tag> {
    ...
    /**
     * Проводит упорядочивающее сравнение тегов по значению.
