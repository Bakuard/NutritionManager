...
public interface UserRepository {
    ...
    /**
     * Возвращает пользователя по его имени. Если пользователя с таким именем не существует - возвращает пустой Optional.
    ...
    /**
     * Возвращает пользователя по его почте. Если пользователя с такой почтой не существует - возвращает пустой Optional.
    ...
    /**
     * Возвращает пользователя по его ID. Если пользователя с таким ID не существует - выбрасывает исключение.
     * @param userId уникальный идентификатор пользователя.
     * @return пользователя по его ID.
     * @throws ValidateException если верно одно из следующих условий:<br/>
    ...
    /**
     * Возвращает пользователя по его имени. Если пользователя с таким именем не существует - выбрасывает исключение.
     * @param name уникальное имя пользователя.
     * @return пользователя по его имени.
     * @throws ValidateException если верно одно из следующих условий:<br/>
    ...
    /**
     * Возвращает пользователя по его почте. Если пользователя с такой почтой не существует - выбрасывает исключение.
     * @param email уникальная почта пользователя.
     * @return пользователя по его почте.
     * @throws ValidateException если верно одно из следующих условий:<br/>
