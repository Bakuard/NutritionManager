...
public interface ImageRepository {
    ...
    /**
     * Сохраняет URL загружённого изображения.
     * @param userId идентификатор пользователя, который загрузил изображение.
     * @param imageHash хеш-сумма изображения рассчитанная с помощью алгоритма MD5.
     */
