...
public interface JwsBlackListRepository {
    ...
    /**
     * Находит и удаляет из черного списка все токены, время жизни которых превышает или равно указанной дате.
     * @param deadline время относительно которого принимается решение - какие токены удалить из черного списка.
