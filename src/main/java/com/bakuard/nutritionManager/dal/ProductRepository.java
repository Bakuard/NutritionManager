...
public interface ProductRepository {
     ...
     * productId. Если у указанного пользвоателя нет продукта с таким идентификатором - выбрасывает исключение.<br/>
     * Для однозначного определения удаляемого продукта достаточно только его ID, но необходима проверять, что
     ...
     * Для однозначного определения возвращаемого продукта достаточно только его ID, но необходима проверять, что
    ...
    /**
     * Возвращает продукт указанного пользователя по идентификатору этого продукта. Если у указанного
     * пользвоателя нет продукта с таким идентификатором - выбрасывает исключение.<br/>
     * Для однозначного определения возвращаемого продукта достаточно только его ID, но необходима проверять, что
     * пользователь запрашивающий продукт действительно является его владельцем.
     * @param productId идентификатор продукта.
     * @param userId идентификатор пользователя, которому принадлежит продукт.
