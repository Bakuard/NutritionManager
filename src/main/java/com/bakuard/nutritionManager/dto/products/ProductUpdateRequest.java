...
@Schema(description = """
        Данные используемые в запросе на обновление продукта. Не допускается, чтобы один пользователь
...
public class ProductUpdateRequest {
    ...
    @Schema(description = """
            Теги указаныне для данного продукта. Допускается пустой список тегов. Ограничения:<br/>
