...
@Schema(description = """
        JWS токен доступа возвращаемый пользователю в случае успешного завершения регистрации,
         смены учетных данны или аутентификации. Используется для вызова методов контролеров продуктов, блюд и меню.
        """)
