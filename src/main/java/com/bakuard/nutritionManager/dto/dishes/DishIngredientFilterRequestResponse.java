...
public class DishIngredientFilterRequestResponse {
    ...
    @Schema(description = """
            Список магазинов продуктов. Продукты соответствующие данному фильтру должны иметь один из
             ...
             данный параметр должен иметь значение null либо быть пустым массивом.
            """)
    ...
    @Schema(description = """
            Список магазинов продуктов. Продукты соответствующие данному фильтру должны иметь один из
             ...
             то данный параметр должен иметь значение null либо быть пустым массивом.
            """)
    ...
    @Schema(description = """
            Список магазинов продуктов. Продукты соответствующие данному фильтру должны имет как минимум
             ...
             должен иметь значение null либо быть пустым массивом.
            """)
